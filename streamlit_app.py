...
# - Initialize edit box with a friendly greeting so ChatGPT can reply immediately.
...
# If somehow blank, restore the greeting once at startup
...
# ---------------- Local ASR helper ----------------
# Local transcription: faster-whisper (tiny) with optional Vosk fallback.
